      ...
      <div class="modal-header">
        ...
        <form action="#" method="POST" enctype="multipart/form-data" id="add_post_form" novalidate>
            ...
            <div class="mb-3">
                ...
                <input type="text" name="Categorie" class="form-control" placeholder="Categorie" id="" required>
            ...
            <div class="mb-3">
                <label class="button" for="image">Thumbnails</label>
                ...
                <img id="img" src="" alt="preview" style="width: 360px; height: 240px;">
            </div>
            <div class="mb-3">
                <label class="button" for="video">Importer</label>
                ...
                <video src="" id="viewVideo" alt="preview" style="width: 50%; height: 50%;"  >
            </div>
            </div>
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <form action="#" method="POST" enctype="multipart/form-data" id="edit_post_form" novalidate>
            ...
            <div class="mb-3">
                <label for="">Post Categorie</label>
                <input type="text" name="Categorie" class="form-control" placeholder="Categorie" id="Categorie" required>
                <div class="invalid-feedback">Post Categorie is required</div>
            </div>
